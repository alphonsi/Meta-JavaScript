...
function styleAndCelebrate(color, background, fontSize, txt, reason) {
  // Call consoleStyler with the variables passed into the function
  consoleStyler(color, background, fontSize, txt);

  // Call celebrateStyler with the variable passed into the function
  celebrateStyler(reason);
}

// Call styleAndCelebrate with appropriate arguments
styleAndCelebrate("ef7c8e", "fae8e0", "30px", "I made it!", "champions");
